<div class="bg-gray-50 100 mb-6 header p-16 flex justify-center align-middle place-items-center">
    <svg class="w-16 h-16 mr-2 transition transform hover:rotate-12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Pokéball" x="0px" y="0px" viewBox="0 0 595.3 594.1" style="enable-background:new 0 0 595.3 594.1;" xml:space="preserve">
        <style type="text/css">
            .st0{fill:#FFFFFF;}
            .st1{fill:#DFDFDF;}
            .st2{fill:#FF1C1C;}
